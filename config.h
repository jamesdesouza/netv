...
#define FFMPEG_CONFIGURATION "--prefix=/home/jvdillon/ffmpeg_build --extra-cxxflags=-I/usr/local/cuda/include --extra-cflags='-I/home/jvdillon/ffmpeg_build/include -I/usr/local/cuda/include' --extra-ldflags='-L/home/jvdillon/ffmpeg_build/lib -L/usr/local/cuda/lib64' --ld=g++ --enable-gpl --enable-version3 --enable-libtensorrt"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/home/jvdillon/ffmpeg_build/share/ffmpeg"
#define AVCONV_DATADIR "/home/jvdillon/ffmpeg_build/share/ffmpeg"
